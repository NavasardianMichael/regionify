...
const en: CommonNs = {
  ...
  visualizer: {
    ...
    embed: {
      ...
      tooltipSelectRegion: 'Select a region before using embed.',
    ...
    mapStyles: {
      ...
      tooltipEnableLabelDragging: 'Enable Region Label Dragging',
      tooltipDisableLabelDragging: 'Disable Region Label Dragging',
