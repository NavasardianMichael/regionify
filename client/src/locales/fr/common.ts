...
const fr: CommonNs = {
  ...
  plans: {
    ...
    items: {
      observer: {
        ...
        features: [
          "Jusqu'à 5 projets",
          'Styles de carte de base',
          "Qualité d'export jusqu'à 50 %",
      ...
      explorer: {
        name: 'Explorateur',
        description: 'Pour les professionnels et les équipes. Paiement unique, accès à vie.',
        buttonText: 'Acheter Explorateur (à vie)',
        features: [
          'Projets illimités',
          'Tous les styles de carte',
          'Export pleine qualité (PNG, SVG, JPEG)',
          'Support par e-mail',
          'Légendes avancées',
          'Support prioritaire',
        ],
      ...
      chronographer: {
        name: 'Chronographe',
        description: 'Pour les utilisateurs avancés. Paiement unique, accès à vie.',
        buttonText: 'Acheter Chronographe (à vie)',
        features: [
          "Tout ce qu'offre Explorateur",
          'Support prioritaire',
          'Accès anticipé aux nouvelles fonctionnalités',
          'Intégration publique de la carte (URL + iframe) avec SEO',
        ],
      },
    },
  },
  ...
  visualizer: {
    ...
    randomStylesPack: 'Appliquer un pack de styles aléatoire',
    ...
    mapStyles: {
      ...
      collapseZoom: 'Contrôles de zoom',
