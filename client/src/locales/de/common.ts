...
const de: CommonNs = {
  ...
  visualizer: {
    ...
    region: {
      sectionTitle: 'Region auswählen',
      placeholder: 'Region auswählen...',
      ariaLabel: 'Region auswählen',
      changeConfirmTitle: 'Region wechseln?',
      changeConfirmBody:
    ...
    importData: {
      ...
      manualTooltipNoRegion: 'Zuerst eine Region auswählen',
