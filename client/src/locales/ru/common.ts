  ...
  visualizer: {
    ...
    manualEntry: {
      ...
      googleSheetsSyncReadOnlyNote:
        'Проект синхронизирует данные с привязанной Google-таблицей. Таблица обновляется из листа автоматически: здесь нельзя менять значения, выделять строки и использовать действия для строк. Сортировка и поиск по столбцам по-прежнему работают. Меняйте данные в таблице Google или выберите другой тип импорта для правки в этом окне.',
    },
    legendConfig: {
