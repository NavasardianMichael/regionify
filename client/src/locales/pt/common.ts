...
const pt: CommonNs = {
  ...
  visualizer: {
    ...
    embed: {
      ...
      tooltipSelectRegion: 'Selecione uma região antes de usar o embed.',
    ...
    mapStyles: {
      ...
      tooltipEnableLabelDragging: 'Ativar arrasto de etiquetas de região',
      tooltipDisableLabelDragging: 'Desativar arrasto de etiquetas de região',
