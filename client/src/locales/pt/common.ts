...
const pt: CommonNs = {
    ...
    items: {
      observer: {
        ...
        features: [
          ...
          'Qualidade de exportação até 50%',
      ...
      explorer: {
        name: 'Explorador',
        description: 'Para profissionais e equipas. Pagamento único, acesso vitalício.',
        buttonText: 'Comprar Explorador (vitalício)',
        features: [
          'Projetos ilimitados',
          'Todos os estilos de mapa',
          'Exportação em qualidade total (PNG, SVG, JPEG)',
          'Suporte por e-mail',
          'Legendas avançadas',
          'Suporte prioritário',
        ],
      ...
      chronographer: {
        name: 'Cronógrafo',
        description: 'Para utilizadores avançados. Pagamento único, acesso vitalício.',
        buttonText: 'Comprar Cronógrafo (vitalício)',
        features: [
          'Tudo do Explorador',
          'Suporte prioritário',
          'Acesso antecipado a novas funcionalidades',
          'Incorporação pública do mapa (URL + iframe) com SEO',
        ],
      },
    },
  },
  ...
  visualizer: {
    ...
    region: {
      sectionTitle: 'Selecionar região',
      placeholder: 'Selecione uma região...',
      ariaLabel: 'Selecionar uma região',
      changeConfirmTitle: 'Alterar região?',
      changeConfirmBody:
    ...
    importData: {
      ...
      manualTooltipNoRegion: 'Selecione primeiro uma região',
      ...
      selectRegionFirst: 'Selecione primeiro uma região',
    ...
    googleSheets: {
      ...
      intro:
        'Cole o URL de uma folha Google pública. A folha deve estar partilhada como «Qualquer pessoa com a ligação».',
    ...
    embed: {
      ...
      keywordPlaceholder: 'Adicionar palavra-chave',
      save: 'Guardar definições do embed',
    ...
    mapStyles: {
      ...
      collapseZoom: 'Controlos de zoom',
