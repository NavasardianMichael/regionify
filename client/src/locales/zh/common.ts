...
const zh: CommonNs = {
  ...
  plans: {
    ...
    items: {
      ...
      chronographer: {
        ...
        buttonText: '购买 Chronographer（一次性）',
      },
    },
  },
  auth: {
  ...
  visualizer: {
    ...
    googleSheets: {
      title: '从 Google 表格导入',
      intro: '粘贴公开 Google 表格的链接。分享设置需为「知道链接的任何人」。',
    ...
    embed: {
      ...
      modalTitle: '公开地图嵌入',
      openButton: '嵌入',
      intro: '通过链接或 iframe 分享只读地图。需要 Chronographer 方案。SEO 字段用于独立嵌入页面。',
      publicToggle: '启用公开嵌入',
      seoTitle: '页面标题（SEO）',
      titleMax: '最多 200 个字符',
      ...
      planRequired: '公开嵌入需要 Chronographer 方案。',
      tooltipChronographerBody: '公开地图嵌入（分享链接与 iframe）包含在 Chronographer 方案中。',
      upgradePlansLink: '查看方案并升级',
      tooltipNeedSavedProject: '请先将地图保存为项目，再配置嵌入。',
      tooltipSelectRegion: '使用嵌入前请先选择区域。',
    ...
    exportModal: {
      upgradeToExplorer: '升级到 Explorer',
    ...
    mapStyles: {
      ...
      tooltipEnableLabelDragging: '启用区域标签拖动',
      tooltipDisableLabelDragging: '禁用区域标签拖动',
      showLabels: '显示标签',
      fontSize: '字号',
    },
    legendStyles: {
