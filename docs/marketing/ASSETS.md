...
| --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `docs/marketing/assets/*.png`           | Screenshots shown inline in the LinkedIn post / Medium article                                                                                            | `pnpm generate-marketing-screenshots` |
| `docs/marketing/assets/demo-video.webm` | ~30 s demo clip used in the LinkedIn post + Medium article                                                                                                | `pnpm generate-demo-video`            |
...
## `docs/marketing/assets/` — social-media screenshots
...
Outputs overwrite anything in `docs/marketing/assets/`.
...
- The **top half**: crop `docs/marketing/assets/data-import-panel.png` to the modal region (shows the messy CSV)
...
## Demo video (`demo-video.webm`)

Auto-generated by `pnpm generate-demo-video`. ~30 seconds, 1280 × 720, no audio.
...
- Local ffmpeg (if installed):
  `ffmpeg -i demo-video.webm -c:v libx264 -pix_fmt yuv420p -crf 22 demo-video.mp4`
